package com.tl.tim.gateway.service.impl;


import com.tl.tim.common.core.proxy.ProxyManager;
...
import com.tl.tim.common.util.RouteInfoParseUtil;
import com.tl.tim.gateway.api.vo.req.ChatReqVO;
import com.tl.tim.gateway.api.vo.req.LoginReqVO;
import com.tl.tim.gateway.api.vo.res.RegisterInfoResVO;
import com.tl.tim.gateway.api.vo.res.TIMServerResVO;
import com.tl.tim.gateway.constant.Constant;
import com.tl.tim.gateway.service.AccountService;
import com.tl.tim.gateway.service.UserInfoCacheService;
...
public class AccountServiceRedisImpl implements AccountService {
    ...
    private String ACCOUNT_PREFIX  = Constant.ACCOUNT_PREFIX;
    private String ROUTE_PREFIX  = Constant.ROUTE_PREFIX;
    private String OFF_LINE  = Constant.OFF_LINE;
