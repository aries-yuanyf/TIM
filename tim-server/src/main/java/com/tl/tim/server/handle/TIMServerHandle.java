package com.tl.tim.server.handle;

import com.tl.tim.common.constant.Constants;
...
import com.tl.tim.common.protocol.TIMReqMsg;
import com.tl.tim.common.util.NettyAttrUtil;
import com.tl.tim.server.kit.RouteHandler;
import com.tl.tim.server.kit.ServerHeartBeatHandlerImpl;
import com.tl.tim.server.util.SessionSocketHolder;
import com.tl.tim.server.util.SpringBeanFactory;
...
public class TIMServerHandle extends SimpleChannelInboundHandler<TIMReqMsg> {
    ...
    @Override
    protected void messageReceived(ChannelHandlerContext channelHandlerContext, TIMReqMsg timReqMsg) throws Exception {
