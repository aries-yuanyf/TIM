package com.tl.tim.common.core.proxy;
    ...
    private class ProxyInvocation implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (args != null && args.length > 1) {
                throw new com.tl.tim.common.exception.TIMException(com.tl.tim.common.enums.StatusEnum.VALIDATION_FAIL);
            }
            ...
            return com.tl.tim.common.util.HttpClient.call(okHttpClient, jsonObject.toString(), serverUrl);
        }
    }
}
